...
// Fix: Adding missing theme colors constant
...
// Fix: Adding missing theme gradients constant
...
// Fix: Adding missing social platforms constant
...
// Fix: Adding missing background presets constant
...
// Fix: Adding missing pattern presets constant
...
// Fix: Adding missing SVG presets constant
...
// Fix: Adding missing sample data constant
...
export const TRANSLATIONS: TranslationStrings = {
  ...
  selectTemplate: { en: 'Select Style', ar: 'اختر النمط الهيكلي', es: 'Seleccionar estilo', fr: 'Choisir le style', de: 'Stil wählen', zh: '选择样式', ja: 'スタイルを選択', pt: 'Selecionار Estilo', ru: 'Выбрать стиль', hi: 'शैली चुनें' },
  ...
  height: { en: 'Height', ar: 'الارتفاع', es: 'Altura', fr: 'Hauteur', de: 'Höhe', zh: '高度', ja: '高さ', pt: 'Altura', ru: 'Высоتا', hi: 'ऊंचाई' },
  size: { en: 'Size', ar: 'الحجم', es: 'Tamaño', fr: 'Taille', de: 'Größe', zh: '尺寸', ja: 'サイズ', pt: 'Tamanho', ru: 'Размер', hi: 'أكار' },
  yOffset: { en: 'Y Offset', ar: 'الإزاحة الرأسية', es: 'Desplazamiento Y', fr: 'Décalage Y', de: 'Y-Versatz', zh: 'Y偏移', ja: 'Yオフセット', pt: 'Deslocamento Y', ru: 'Смещение по Y', hi: 'Y অফसेट' },
